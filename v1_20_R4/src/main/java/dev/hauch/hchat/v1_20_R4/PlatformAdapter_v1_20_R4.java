package dev.hauch.hchat.v1_20_R4;
...
// class PlatformAdapter_v1_20_R4
public final class PlatformAdapter_v1_20_R4 implements PlatformAdapter {

    private static final int TICKS_TO_MS = 50;

    @Override
    // get id
    public String getId() { return "v1_20_R4"; }

    @Override
    // get display name
    public String getDisplayName() { return "1.20.5 / 1.20.6"; }
